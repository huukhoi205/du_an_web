...
--
-- Table structure for table `thumuacu` (ENHANCED WITH NEW COLUMNS)
--
...
CREATE TABLE `thumuacu` (
  ...
  `SanPhamLienQuan` varchar(200) DEFAULT NULL,
  `DiaChi` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`MaTMC`),
  KEY `MaND` (`MaND`),
...
(1,1,'iPhone X 64GB','Apple','Trầy nhẹ, pin còn 85%',3000000,4000000,'HoanTat','iphone_x_64gb.jpg','2025-10-01 10:00:00','2025-10-15 14:30:00','Điện thoại còn mới, ít sử dụng','không','123 Nguyễn Trãi, Hà Nội'),
(2,2,'iPhone 12 Pro Max 256GB','Apple','Màn hình có vết trầy nhẹ, máy hoạt động bình thường',8000000,8500000,'ChoDuyet','iphone_12_pro_max.jpg','2025-10-02 15:20:00','2025-10-02 15:20:00','Máy còn bảo hành, pin 90%','iPhone 13 Pro Max','456 Lê Lợi, TP.HCM'),
(3,1,'Samsung Galaxy S21 Ultra 512GB','Samsung','Máy còn bảo hành, pin 90%',12000000,13000000,'DangDinhGia','samsung_s21_ultra.jpg','2025-10-03 09:15:00','2025-10-10 11:45:00','Máy còn bảo hành, pin 90%','không','789 Trần Hưng Đạo, Đà Nẵng'),
(4,2,'Xiaomi Mi 11 8GB/256GB','Xiaomi','Máy mới 99%, còn hộp sách',6000000,6500000,'ChoDuyet','xiaomi_mi11.jpg','2025-10-04 16:30:00','2025-10-04 16:30:00','Máy mới 99%, còn hộp sách','Samsung Galaxy S22','321 Nguyễn Du, Hải Phòng'),
(5,1,'OPPO Find X3 Pro 12GB/256GB','OPPO','Màn hình OLED đẹp, camera chụp tốt',7000000,7500000,'HoanTat','oppo_find_x3_pro.jpg','2025-10-05 11:00:00','2025-10-12 09:20:00','Màn hình OLED đẹp, camera chụp tốt','không','654 Hoàng Hoa Thám, Cần Thơ'),
(6,1,'s22 ULTRA','Samsung','rtydu',525221581,NULL,'ChoDuyet',NULL,'2025-10-17 15:30:00','2025-10-17 15:30:00','Tình trạng: rtydu | Sản phẩm muốn đổi: không | Khu vực: an nhơn bình định','không','an nhơn bình định'),
(7,2,'iPhone 13 Pro','Apple','Mới 95%',15000000,NULL,'ChoDuyet',NULL,'2025-10-17 15:30:00','2025-10-17 15:30:00','Tình trạng: Mới 95% | Sản phẩm muốn đổi: iPhone 14 Pro | Khu vực: TP.HCM','iPhone 14 Pro','TP.HCM'),
(8,3,'Xiaomi 12 Pro','Xiaomi','Trầy nhẹ',8000000,NULL,'DangDinhGia',NULL,'2025-10-17 15:30:00','2025-10-17 15:30:00','Tình trạng: Trầy nhẹ | Sản phẩm muốn đổi: không | Khu vực: Hà Nội','không','Hà Nội');
