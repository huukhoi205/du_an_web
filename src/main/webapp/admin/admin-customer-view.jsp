        ...
        <div class="main-content">
            ...
            <div class="admin-container">
                ...
                <div class="customer-detail">
                    ...
                    <div class="detail-actions">
                        <a href="${pageContext.request.contextPath}/admin/customer/edit?maND=${customer.maND}" class="btn btn-primary">Sửa thông tin</a>
                        <a href="${pageContext.request.contextPath}/admin/customer/list" class="btn btn-secondary">Quay lại</a>
                    </div>
                </div>
            </div>
        </div>
