                    ...
                    <div class="filter-group">
                        ...
                        <div class="filter-options">
                            <label class="filter-option">
                                <input type="radio" name="product-type" value="new" checked>
                                <span>Điện thoại mới</span>
                            </label>
                            <label class="filter-option">
                                <input type="radio" name="product-type" value="used" onchange="window.location.href='${pageContext.request.contextPath}/views/used-phones.jsp'">
                    ...
                    <div class="filter-group">
                        ...
                        <div class="price-slider-container">
                            ...
                            <div class="price-buttons">
                                <button class="price-btn" onclick="setPriceRange(1000000, 3000000)">1 ₫ến 3 triệu</button>
                                <button class="price-btn" onclick="setPriceRange(0, 1000000)">Dưới 1 triệu</button>
                                <button class="price-btn" onclick="setPriceRange(3000000, 5000000)">3 ₫ến 5 triệu</button>
                                <button class="price-btn" onclick="setPriceRange(5000000, 10000000)">5 ₫ến 10 triệu</button>
                            </div>
                ...
                <div class="products-content">
                    ...
                    <div class="products-grid">
                        ...
                        <div class="product-card" onclick="viewProduct('<%= product.getTenSP() %>')">
                            <% if (product.getGia().compareTo(new java.math.BigDecimal("20000000")) > 0) { %>
                            ...
                            <div class="installment">Góp 0%, 0 phí</div>
                            <div class="product-price">
                                <% if (product.getGia().compareTo(new java.math.BigDecimal("20000000")) > 0) { %>
                                <span class="old-price"><%= formatter.format(product.getGia().multiply(new java.math.BigDecimal("1.2"))) %> ₫</span>
                                <% } %>
    ...
    <section class="articles-section">
        <div class="container">
            <div class="article-content">
                <p>Từ khi ra ₫ời, ₫iện thoại ₫ã trở thành một phần không thể thiếu trong cuộc sống hàng ngày của con người. Với khả năng kết nối internet, chụp ảnh, nhắn tin, thanh toán ngân hàng, ₫ịnh vị GPS, giải trí và nhiều tính năng khác, ₫iện thoại ₫ã giúp cuộc sống trở nên tiện lợi và hiệu quả hơn. Đặc biệt, trong thời ₫ại công nghệ số hiện nay, ₫iện thoại còn ₫óng vai trò quan trọng trong việc học tập, làm việc và nghiên cứu.</p>
                
                <h3>Điện thoại di ₫ộng - "Người ₫ồng hành" không thể thiếu trong thời ₫ại mới</h3>
                
                <p>Với sự phát triển không ngừng của công nghệ, ₫iện thoại thông minh ₫ã trở thành công cụ không thể thiếu trong cuộc sống hiện ₫ại. Từ những chiếc ₫iện thoại ₫ầu tiên ₫ến những smartphone hiện ₫ại ngày nay, lịch sử phát triển của ₫iện thoại ₫ã trải qua nhiều giai ₫oạn với những bước tiến ₫áng kể.</p>
                
                <h3>Sự kiện tạo nên ₫ột phá của ngành công nghiệp ₫iện thoại</h3>
                
                <p>Lịch sử của ₫iện thoại bắt ₫ầu từ thế kỷ 19 với những phát minh ₫ầu tiên. Tuy nhiên, chỉ ₫ến ₫ầu thế kỷ 21, với sự ra ₫ời của smartphone, ₫iện thoại mới thực sự bùng nổ và thay ₫ổi cách con người giao tiếp và làm việc. Đặc biệt, sự xuất hiện của iPhone vào năm 2007 và hệ ₫iều hành Android của Google ₫ã tạo nên cuộc cách mạng thực sự trong ngành công nghiệp ₫iện thoại.</p>
