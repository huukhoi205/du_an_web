...
<%@ page import="model.UserProfile, model.ExchangeRequest" %>
...
<%
    ...
    ExchangeRequest exchangeRequest = (ExchangeRequest) request.getAttribute("exchangeRequest");
...
<head>
    ...
    <title>Chi tiết đơn thu mua - KT Store</title>
                ...
                <div class="success-container">
                    ...
                    <div class="repair-info">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">#<%= exchangeRequest.getMaTMC() %></span>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value"><%= exchangeRequest.getHangSX() %></span>
                        </div>
